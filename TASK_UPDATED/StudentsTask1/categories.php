...
<div class="row">
  ...
  <div class="column middle">
    <div class="actions">
      <a class="linkaction" href="categoryadd.php?">Add Category</a>
    ...
    <div class="box">
      ...
      <hr />
      <div class="actions">
      <a class="linkaction" href="categorydelete.php?action=delete&id=<?php echo $category['id'];?>">Delete Category</a>
